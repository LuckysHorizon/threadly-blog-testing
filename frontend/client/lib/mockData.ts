...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "Explore how AI is revolutionizing healthcare, finance, and education with cutting-edge applications and real-world implementations.",
    authorId: "admin-1",
  ...
  },
  {
    ...
    excerpt:
      "Deep dive into the most important ML algorithms every data scientist should know, with practical examples and implementation tips.",
    authorId: "user-1",
  ...
  },
  {
    ...
    excerpt:
      "An in-depth analysis of the leading AI assistants, comparing their capabilities, strengths, and ideal use cases.",
    authorId: "user-2",
  ...
  },
  {
    ...
    excerpt:
      "Step-by-step tutorial for beginners to create and train their first neural network using PyTorch framework.",
    authorId: "user-3",
    publishedAt: "1 week ago",
  ...
  },
  {
    ...
    excerpt:
      "Understanding the ethical implications of AI technology and frameworks for building responsible AI systems.",
    authorId: "admin-1",
  ...
  },
  {
    ...
    excerpt:
      "How computer vision and AI are transforming medical imaging and improving diagnostic accuracy in healthcare.",
    authorId: "user-1",
    publishedAt: "2 weeks ago",
  ...
  },
  {
    ...
    excerpt:
      "The evolution of NLP models and their impact on how machines understand and generate human language.",
    authorId: "user-2",
  ...
  },
  {
    ...
    excerpt:
      "Exploring the intersection of quantum computing and artificial intelligence, and what it means for the future.",
    authorId: "user-3",
  ...
  // Draft posts (visible only to authors and admins)
  {
    ...
    excerpt:
      "Exploring cutting-edge RL algorithms and their applications in robotics and game AI.",
    authorId: "user-1",
    publishedAt: "Draft",
  ...
  // Pending posts (waiting for admin approval)
  {
    ...
    excerpt:
      "How edge computing is revolutionizing AI deployment in Internet of Things applications.",
    authorId: "user-2",
    publishedAt: "Pending Review",
    readTime: "11 min read",
    category: "Edge Computing",
    coverImage:
      "https://images.unsplash.com/photo-1518709268805-4e9042af2d39?w=800&h=400&fit=crop",
